...
1. **Identify the correction.** What did the agent do, and what did the user actually want? If it is ambiguous which of two things was the mistake, ask one short question. Never guess.
